...
/** Connect to MongoDB */
mongoose.connect(process.env.DATABASE_URL || "mongodb+srv://uchihaItachiTrueHero:UchihaItachiTrueHero@cluster0.swmsudh.mongodb.net/Collab-text-editor?retryWrites=true&w=majority&appName=Cluster", { dbName: "Google-Docs" })
